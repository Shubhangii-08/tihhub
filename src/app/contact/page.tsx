    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-4 flex flex-row items-center justify-between w-full max-w-4xl mx-auto min-h-fit">
            <div className="flex flex-col flex-1 min-w-0">
              <h2 className="text-2xl font-bold text-[#021954] mb-2">Mail us at</h2>
              <div className="flex items-center mb-4">
                <span className="bg-[#021954]/10 rounded-full p-2 mr-3"><FaEnvelope className="text-[#021954] text-2xl" /></span>
                <a href="mailto:admin@ihub-drishti.ai" className="text-xl font-semibold text-[#021954] hover:underline truncate">admin@ihub-drishti.ai</a>
              </div>
              <h3 className="text-lg font-semibold text-[#021954] mb-2">You can also contact us here:</h3>
              <div className="flex gap-6 mb-2">
                <div className="flex items-center gap-2">
                  <span className="bg-[#021954]/10 rounded-full p-2"><FaLinkedin className="text-[#021954] text-2xl" /></span>
                  <a href="https://www.linkedin.com/company/ihub-drishti/" target="_blank" rel="noopener noreferrer" className="text-[#021954] hover:underline font-medium">LinkedIn</a>
                </div>
        ...
        <div className="flex justify-center">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 w-full max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-[#021954] mb-6 text-center">Key Contacts</h2>
        ...
        <div className="flex justify-center">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 w-full max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-[#021954] mb-6 text-center">Our Location</h2>
            <div className="relative pb-[56.25%] h-0 overflow-hidden rounded-xl border border-gray-200">
              <iframe
                ...
                title="TIH, iHub Drishti Foundation, IIT Jodhpur Location"
              ></iframe>
            </div>
          </div>
        </div>
